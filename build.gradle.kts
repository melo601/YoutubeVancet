...
dependencies {
    implementation("com.cuynuvanced:vanced-patcher:1.0.0")
    implementation("com.cuynuvanced:multidexlib2:2.5.3-a3836654")
    // Required for meta
...
tasks {
    ...
    register<JavaExec>("generateMeta") {
        ...
        mainClass.set("com.cuynuanced.meta.PatchesFileGenerator")
    }
